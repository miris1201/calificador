...
$rs_count       = $cLista->getAllElementos(); //Cuenta todos los registros (le doy 0 al limite)
$countRegistros = $rs_count->rowCount();
$numeroTotalPaginas = ceil($countRegistros/$registros);

$cLista->setLimite(1);
$rsRegShow = $cLista->getAllElementos(); //Trae todos los registros (ya le puse limite)
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-striped">
                                        ...
                                        while ($rowReg    = $rsRegShow->fetch(PDO::FETCH_OBJ)) {
                                            ...
                                            $id_zona      = $rowReg->id_zona;
                                            $no_empleado  = $rowReg->no_empleado;
                                            ...
                                            $zona = ($id_zona == 1) ? 'Poniente' : 'Oriente';

                                            ?>
                                            <tr>
                                                <td><span class="pull-left <?php echo $showEstatus?>"></span></td>
                                                <td><?php echo $no_empleado?></td>
                                                <td><?php echo $zona?></td>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    if($_SESSION[elim] == 1){ ?>
                                                        <a 
                                                            onclick="handleDeleteE(<?php echo $iId.','.$bajaAlta ?>)"
                                                        ...
                                                        <a 
                                                            onclick="handleDeleteE(<?php echo $iId?>, 3)" 
                                                            data-toggle="tooltip"
